...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        System.out.println(y3);
         ...
         //pre increment: increases or declerases the value immediately

        int z = 100;
        System.out.println(++z); // incerases immediately
        System.out.println(z); // 101

        //post increment : increases or decreases value by not immediately
        int P = 100;
